...
12. [Configure the Disk on Linux VM01](#configure-the-disk-on-linux-vm01)
   ...
   * [Partition a new disk](#partition-a-new-disk)
   * [Mount the disk](#mount-the-disk)
   * [Ensure mounting during the boot](#ensure-mounting-during-the-boot)
14. [Configure the Disk on Linux VM02](#configure-the-disk-on-linux-vm02)
   * [Find the disk](#find-the-disk-1)
   * [Partition a new disk](#partition-a-new-disk-1)
   * [Mount the disk](#mount-the-disk-1)
   * [Ensure mounting during the boot](#ensure-mounting-during-the-boot-1)
16. [Install GlusterFS on Linux VM01](#install-glusterfs-on-linux-vm01)
17. [Install GlusterFS on Linux VM02](#install-glusterfs-on-linux-vm02)
18. [Configure GlusterFS on Linx VM01](#configure-glusterfs-on-linx-vm01)
19. [Configure GlusterFS on Linx VM02](#configure-glusterfs-on-linx-vm02)
20. [Test](#test)
