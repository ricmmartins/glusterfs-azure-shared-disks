...
6. [Create the second virtual machine (myVM02)](#create-the-second-virtual-machine-myvm02)
7. [Create a Shared Data Disk](#create-a-shared-data-disk)
8. [Create a proximity placement group](#create-a-proximity-placement-group)
9. [Configure the Disk on Linux VM01](#configure-the-disk-on-linux-vm01)
10. [Configure the Disk on Linux VM02](#configure-the-disk-on-linux-vm02)
11. [Install GlusterFS on Linux VM01](#install-glusterfs-on-linux-vm01)
12. [Install GlusterFS on Linux VM02](#install-glusterfs-on-linux-vm02)
13. [Configure GlusterFS on Linx VM01](#configure-glusterfs-on-linx-vm01)
14. [Configure GlusterFS on Linx VM02](#configure-glusterfs-on-linx-vm02)
15. [Test](#test)
